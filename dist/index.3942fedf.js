...
})({"jHGz9":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "b6cad63c3942fedf";
"use strict";
...
},{}],"9nAcU":[function(require,module,exports) {
...
const controlCalculateRepayment = function(data) {
    _modelJs.updateState(data);
    _modelJs.calculateRepayment();
    (0, _resultViewJsDefault.default).render(_modelJs.state);
};
const clearForm = function(markup) {
    _modelJs.reset();
    console.log(_modelJs.state);
    (0, _resultViewJsDefault.default).reset(markup);
};
const init = function() {
    (0, _calculatorViewJsDefault.default).addHandlerSubmit(controlCalculateRepayment);
    (0, _calculatorViewJsDefault.default).addHandlerClear(clearForm);
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","./views/calculatorView.js":"jCpfC","./views/resultView.js":"Ne1qV","./model.js":"hpwRU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
},{"aa6765693e58a0fe":"9fY7y","a68ecfcbf29c46f6":"148ka","7087588d33667af2":"l3Kyn","864edee099e8affb":"888a9","3a3a5a2cfab86f21":"lApyY","cff2c830bdea4f24":"RsFXo","58a74f00cee1ac64":"b9O3D"}],"jCpfC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _illustrationEmptySvg = require("../../assets/images/illustration-empty.svg");
...
class CalculatorView {
    ...
    _generateMarkup() {
        return ` <img src="${0, _illustrationEmptySvgDefault.default}" alt="calculator illustration">
        <h2 class="title results-title">Results shown here</h2>
        <p class="body-text results-description">Complete the form and click \u{201C}calculate repayments\u{201D} to see
...
},{"../../assets/images/illustration-empty.svg":"d6fsJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d6fsJ":[function(require,module,exports) {
module.exports = require("c3f7bd3db0932ad3").getBundleURL("fGZXh") + "illustration-empty.6357567b.svg" + "?" + Date.now();

},{"c3f7bd3db0932ad3":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"Ne1qV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class ResultView {
    ...
    _generateMarkup() {
      ...
      <p class="body-text body-text--2"> Your results Your results are shown below based on the information you
        provided. To adjust the results, edit the form and click \u{201C}calculate
        repayments\u{201D} again.</p>
      <div class="card">
        <p class="monthly-repayment body-text--2">Your monthly repayments</p>
        <p class="repayment-result">&#163;${this._data.monthlyPayment}</p>
        <p class="term-repayment body-text--2">Total ${this._data.mortgageType === "repayment" ? "" : "Interest"}  you'll repay over the term
        </p>
        <p class="total-result">&#163;${this._data.mortgageType === "repayment" ? this._data.totalRepayment : this._data.totalInterest}</p>
      </div>`;
    }
}
exports.default = new ResultView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hpwRU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "reset", ()=>reset);
parcelHelpers.export(exports, "updateState", ()=>updateState);
parcelHelpers.export(exports, "calculateRepayment", ()=>calculateRepayment);
let state = {};
...
const calculateRepayment = function() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jHGz9","9nAcU"], "9nAcU", "parcelRequire94e6")

//# sourceMappingURL=index.3942fedf.js.map
